class OrdersController < ApplicationController
  ...
  def order_params
    order_params = params[:order].permit(:member_id, :postage, :amount_billed, :payment_method, :shipping_address, :postal_code,
                          :purchaser_last_name, :purchaser_first_name, :purchaser_email)
    order_params[:postal_code] = order_params[:postal_code].gsub(/-/, '')
    order_params
  end
end
